                ...
                <div class="card-body text-white">
                    <form method="POST" action="{{ route('profile.password.updateProfile') }}">
                        ...
                        <div class="row mx-0 w-100 ">
                            <a class="text-white" href="{{ Auth::user()->referral_link }}" id="referral-link">{{ Auth::user()->referral_link }}</a>
                            <button class="ml-auto btn btn-primary" id="copy-button"><i class="fa fa-clipboard"></i> Copy</button>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="col-12 col-sm-6 px-0">
                                    <img class="pb-3" src="{{Auth::user()->getFirstMediaUrl('profile_photos') ?? '/img/user.jpg'}}" alt="{{ Auth::user()->name }}" style="height: 200px; width: 200px;">                                    
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label p-2" for="inputGroupFile01">Choose file</label>
                                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" id="datepicker" class="form-control" name="date_of_birth" value="{{ old('date_of_birth', $user->date_of_birth) }}" placeholder="Select Date">
...
@section('scripts')
    <script type="text/javascript">
        ...
        function uploadFile(file) {
            ...
            $.ajax({
                url: "{{ route('profile.password.updateProfilePhoto') }}", // Replace with your server-side upload endpoint
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
