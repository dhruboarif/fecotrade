...
<html lang="en" >
  <head>
    <meta charset="utf-8">
      ...
      <!-- Favicon -->
      <link rel="shortcut icon" href="{{asset('public/assets1/images/favicon.ico')}}" />
      <link rel="stylesheet" href="{{asset('public/assets1/css/libs.min.css')}}">
      <link rel="stylesheet" href="{{asset('public/assets1/css/coinex.css?v=1.0.0')}}">
      <link rel="stylesheet" href="{{asset('public/assets1/css/custom.css')}}">  </head>
  <body class="" data-bs-spy="scroll" data-bs-target="#elements-section" data-bs-offset="0" tabindex="0">
   <div id="video-background">
      <!-- Video Library -->
    <video onload="this.play();" autoplay loop muted>
      <source src="{{asset('public/assets1/images/animation_video_1.mp4')}}" type="video/mp4" codecs="avc1.4D401E, mp4.40.2">
    </video>
  </div>
...
<section class="vh-100 bg-image">
   <div class="container h-100">
               ...
               <div class="card-body">
                  <div class="auth-form">
                    ...
                    <div class="text-center mb-2">
                     <a href="https://fecotrade.com"><img class="justify-content-center" src="{{asset('public/assets1/images/facotrade_logo.png')}}" alt="Fecotrade"></a>
                    </div>
                           ...
                           <div class="row">
                              ...
                              <div class="col-md-6 mb-4">
                                 <div class="form-floating mb-3">
                                       ...
                                       <label for="sponsor">Affiliator User ID</label>
                                 </div>
    ...
    <script src="{{asset('public/assets1/js/libs.min.js')}}"></script>
    <!-- widgetchart JavaScript -->
    <script src="{{asset('public/assets1/js/charts/widgetcharts.js')}}"></script>
    <!-- fslightbox JavaScript -->
    <script src="{{asset('public/assets1/js/fslightbox.js')}}"></script>
    <!-- app JavaScript -->
    <script src="{{asset('public/assets1/js/app.js')}}"></script>
    <!-- apexchart JavaScript -->
    <script src="{{asset('public/assets1/js/charts/apexcharts.js')}}"></script>
    <script>
