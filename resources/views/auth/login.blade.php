...
<html lang="en" >
  <head>
    <meta charset="utf-8">
      ...
      <link rel="stylesheet" href="{{asset('assets1/css/coinex.css?v=1.0.0')}}">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="auth-form">
                            ...
                            <a href="https://fecotrade.com"><img class="justify-content-center" src="{{asset('assets1/images/facotrade_logo.png')}}" alt="Fecotrade"></a>
                            </div>
