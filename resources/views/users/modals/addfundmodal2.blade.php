              ...
              <section id="multiple-column-form">
                  <div class="row">
                      <div class="col-12">
                        ...
                        <select id="DestinationOptions2" name="wallet_id" class="form-control" aria-label="Default select example" required>
                        ...
                        @endforeach
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="wallet_id2" id="wallet_id2" class="form-control" readonly>

                                <button class="text-dark" onclick="copyText()">Copy Wallet or Account No</button>
                            </div>
