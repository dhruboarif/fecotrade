<div class="modal fade text-left" id="transfermining" tabindex="-1" role="dialog" aria-labelledby="myModalLabel17" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel17">Mining Wallet to Withdraw Wallet</h4>
                          ...
                          <div class="card">
                              ...
                              <form method="post" action="{{route('transfer-fund-store')}}">
                                ...
                                <div class="mb-3" style="display: none;">
                                 ...
                                 <option value="Mining Wallet" selected>From Mining Wallet</option>
