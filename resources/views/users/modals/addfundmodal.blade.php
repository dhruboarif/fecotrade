    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title text-white " id="myModalLabel17">Add Fund</h4>
                      ...
                      <div class="col-12">
                        ...
                        @endforeach
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="wallet_id" id="wallet_id" class="form-control" readonly>
                            ...
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Amount (DOGE)</label>
