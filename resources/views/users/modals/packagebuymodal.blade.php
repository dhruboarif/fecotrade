    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel17">Buy Contract</h4>
              ...
              <section id="multiple-column-form">
                  <div class="row">
                      <div class="col-12">
                        ...
                        <div class="mb-3">
                            Are you sure you want to Buy this Contract?
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary">Buy From Asset Wallet</button>
                </form>
