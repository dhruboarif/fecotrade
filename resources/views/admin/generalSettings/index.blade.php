            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.general-settings.update', '1') }}" method="post">
                        ...
                        <div class="form-group">
                            <label class="required" for="currency_name">Currency Name</label>
                        ...
                        <div class="form-group">
                            <label class="required" for="currency_symbol">Currency Symbol</label>
                         ...
                         <div class="form-group">
                            <label class="required" for="currency_symbol">Minimun Withdraw</label>
                            <input class="form-control {{ $errors->has('min_withdraw') ? 'is-invalid' : '' }}" type="text" name="min_withdraw" id="min_withdraw" value="{{ old('min_withdraw', $generalSettings->min_withdraw ?? '') }}">
                            @if ($errors->has('min_withdraw'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('min_withdraw') }}
                                </div>
                            @endif
                        </div>
                         <div class="form-group">
                            <label class="required" for="currency_symbol">Withdraw Charge</label>
                            <input class="form-control {{ $errors->has('withdraw_charge') ? 'is-invalid' : '' }}" type="text" name="withdraw_charge" id="withdraw_charge" value="{{ old('withdraw_charge', $generalSettings->withdraw_charge ?? '') }}">
